...
namespace SudoBot.Specifics
{
    public class HungerGames
    {
        public List<HungerGamesLine> Lines = new List<HungerGamesLine>
        {
            ...
            new HungerGamesLine("(...) holt sich ein Eis. (...) klaut sich das Eis und wird von (...) mit einer Pistole erschossen. 
            ...
            new HungerGamesLine("(...) wurde beim Versuch zu cheaten erwischt.
            new HungerGamesLine("(...) hat so lange gewartet, dass ein neue Runde Hungergames beginnt sodass er, nach dem er sich so gefreut hatte, nicht darauf geachtet hatte wo er gerade hin läuft. Naja. Der Bär hat nun eine noch heftigere Killstreak.
            new HungerGamesLine("(...) wird vom Wolf gefressen, der gerade auf der Suche nach Rotkäppchen war. Später erschießt der Jäger den Wolf und befreit (...) wieder. POG Jäger
            new HungerGamesLine("(...) wurde von einem AMG platt gefahren
            new HungerGamesLine("(...) wird beim suchen nach dem legendären Tomaten Drop von einem Unbekannten im Gebüsch erledigt.
            new HungerGamesLine("(...) wird beim öffnen eines Tomaten Drops von (...) überfallen, jedoch werden beide vom allgegenwärtigen Panda vernichtet. (...) schnappt sich die Ausrüstung.
            new HungerGamesLine("(...) ist nach einer langen HG-Runde an Altersschwäche gestorben. (...), (...) und (...) lachen ihn aus, bevor (...)vom Anticheatbot einen Teamingbann bekommt und die anderen knapp entkommen.
            new HungerGamesLine("(...) ist nach einer langen HG-Runde an Altersschwäche gestorben. (...), (...) und (...) lachen ihn aus, bevor (...)vom Anticheatbot einen Teamingbann bekommt und die anderen knapp entkommen.
            new HungerGamesLine("(...) ist nach einer langen HG-Runde an Altersschwäche gestorben. (...), (...) und (...) lachen ihn aus, bevor (...)vom Anticheatbot einen Teamingbann bekommt und die anderen knapp entkommen.
            new HungerGamesLine("(...) ist nach einer langen HG-Runde an Altersschwäche gestorben. (...), (...) und (...) lachen ihn aus, bevor (...)vom Anticheatbot einen Teamingbann bekommt und die anderen knapp entkommen.
            new HungerGamesLine("(...) buggt in der Luft fest und wird vom Server gekickt.
            new HungerGamesLine("(...) erhält einen TomatenDrop und wurde kurz nach dem Öffnen, durch einen Headshot von (...), weggesniped.
            new HungerGamesLine("(...) wurde durch den Stein, den (...) geworfen hat, schwer verletzt.
            new HungerGamesLine("(...) versteckt sich in einer Höhle, (...) kriegt das mit und schießt eine Rocket rein.
            new HungerGamesLine("(...) wollte Dynamit auf (...) werfen, aber hat vergessen los zu lassen.
            new HungerGamesLine("(...) wurde von einem fliegenden Fisch erschlagen.
            new HungerGamesLine("(...) hat die Mods nach !drops gefragt und wurde gebannt.
            new HungerGamesLine("(...) stirbt durch einen herabfallenden Amboss.
            new HungerGamesLine("(...) wollte aus der Arena fliehen. Die Schutzmechanismen der Arena waren wohl stärker als er.
            new HungerGamesLine("(...) will (...) mit einer Briefbombe eliminieren. Leider hat (...) zu wenig Porto auf den Brief geklebt, weswegen der Brief zu ihm zurück kommt. (...) öffnet den Brief ohne darüber nachzudenken und wird von der Bombe getötet.
            new HungerGamesLine("(...) gönnt sich eine Pause, passt aber nicht auf, und schläft ein. (...) nutzt dieses und entlässt (...) in die unendliche Welt des Schlafs.
            new HungerGamesLine("(...) läuft ins hohe Gras und trifft auf eine Horde von Taubsis ... die Schnäbel hatten einiges zu picken.
            new HungerGamesLine("(...) versucht einem wilden Hunden zu entkommen. Als er auf einen Baum geklettert ist wird er leider von fallenden Pandas erschlagen, die genüsslich Bambus neben ihm gegessen hatten. Beim herunter fallen nehmen sie fast noch (...) mit, aber der konnte ganz knapp ausweichen.
            new HungerGamesLine("(...) versucht einem wilden Hunden zu entkommen. Als er auf einen Baum geklettert ist versucht der Hund ihm hinter her zu kommen, aber schafft es nicht. Das war knapp. Aber gerade noch so gerettet.
            new HungerGamesLine("(...) backt für (...) einen Kuchen. Dieser nimmt ihn dankend an. (...) nimmt einen Bissen und stirbt durch das beigemischte Gift
            ...
            new HungerGamesLine("(...) backt für (...) einen Kuchen. Dieser nimmt ihn dankend an. (...) versucht noch vor Ort einen Bissen zu essen. Durch die Bombe im Kuchen werden (...) und (...) in die Luft gesprengt.
            new HungerGamesLine("(...) und (...) werfen sich mit Tomaten ab, aber bei (...) war ein Stein drin und trift (...) lebensgefährlich am Kopf.
            new HungerGamesLine("(...) geht schwimmen obwohl er nicht schwimmen kann.
            new HungerGamesLine("(...) denkt saß hier ist Minecraft, schlägt den Baum mit der Faust und verletzt dabei seine Hand.
            new HungerGamesLine("Ein Spieler wurde zu tarzan und springt von Baum zu Baum.
            new HungerGamesLine("(...) fällt von einen Baum und fällt dabei auf (...).
            new HungerGamesLine("(...) und (...) haben Spaß am Rande der Arena und bewerfen sich mit Tomaten.
            new HungerGamesLine("(...) verwechselt die Hungergames mit Djungelcamp und isst eine giftige Tomate. Im Djungelcamp hättest du dafür wenigstens Punkte bekommen. Feels Bad Man
